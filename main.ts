...
function show_intro() {
    game.showLongText(
        "You are Quarion, the brave Humis King!\n" +
        "An ancient evil haunts the stump.\n" +
        "Save the stump from the various monsters.\n" +
        "Enter the stump and lift its curse!", DialogLayout.Bottom)
    seen_intro = true
